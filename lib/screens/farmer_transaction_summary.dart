...
class FarmerTransactionSummary extends StatefulWidget {
  ...
  const FarmerTransactionSummary({
    super.key,
    required this.userId,
  }); // Include userId in constructor

  @override
  _FarmerTransactionSummaryState createState() =>
      _FarmerTransactionSummaryState();
}
...
class _FarmerTransactionSummaryState extends State<FarmerTransactionSummary> {
  ...
  Future<void> fetchProducts() async {
    ...
    var url = Uri.parse(
      "https://test.zuasoko.com/fetch_products?userId=${widget.userId}",
    );
  ...
  Future<void> addProduct() async {
    ...
    var url = Uri.parse(
      "https://test.zuasoko.com/add_product?userId=${widget.userId}",
    );
  ...
  Future<void> updateProduct(int productId) async {
    var url = Uri.parse(
      "https://test.zuasoko.com/update_product?userId=${widget.userId}",
    );
    var request = http.MultipartRequest("POST", url);
